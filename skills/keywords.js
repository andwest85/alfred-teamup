module.exports =  function (controller, bot) {
  ...
  controller.hears(["announcement", "domain"], 'direct_message,direct_mention', function (bot, message) {
      if (message === "announcement" || message === "announcements") {
      ...
      if (message === "domain" || messagae === "domains") {
